...
{		
	...
	private float   YRotation = 90.0f; // FYDP: originally 0.0f
	...
	void UpdateCameras()
	{
		...
		if(FollowOrientation != null) {
			...
			// TODO FOR FYDP: to account for the angle added by the bike pitch,
			// we must subtract the pitch from the OrientationOffset above.
